...
android {
    ...
    buildTypes {
        ...
        configureEach {
            //应用名
            //app name
            resValue("string","app_name","Mesa 25.0.0-rc1")
            //包名后缀
            //package name Suffix
            applicationIdSuffix = ".mesa2500.rc1"

            //渲染器在启动器内显示的名称
            //The name displayed by the renderer in the launcher
            manifestPlaceholders["des"] = "Mesa 25.0.0 RC1"
            ...
            manifestPlaceholders["renderer"] = "Mesa25.0.0-RC1:libOSMBridge.so:libEGL.so"
